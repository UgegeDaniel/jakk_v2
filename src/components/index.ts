...
export { default as EmailVerifationProgress } from './EmailVerificationPageContent/EmailVerifationProgress';
...
export { default as UnVerifiedUserPageContent } from './EmailVerificationPageContent/UnVerifiedUserPageContent';
